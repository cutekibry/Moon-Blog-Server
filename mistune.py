# Copy from https://github.com/lepture/mistune/blob/master/mistune.py
# 2019-03-03 18:59 UTC+8
# Small changes are done by cutekibry
# Search for "# !!! Update Mark !!!" to check the changes
# All rights belong to lepture
# coding: utf-8
"""
    mistune
    ~~~~~~~
...
class Renderer(object):
    ...
    def block_code(self, code, lang=None):
        ...
        #     return '<div class="ui existing segment"><pre><code>%s\n</code></pre></div>\n' % code
        code = escape(code, quote=True, smart_amp=False)
        return '<div class="ui existing segment"><pre><code class="lang-%s">%s\n</code></pre></div>\n' % (lang, code)

    def block_quote(self, text):
        """Rendering <blockquote> with the given text.
        :param text: text content of the blockquote.
        """
        return '<div class="ui message">%s\n</div>\n' % text.rstrip('\n')
...
class Markdown(object):
    ...
    def parse(self, text):
        ...
        out = out.replace('<table>', '<table class="ui celled table">')
